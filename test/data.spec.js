...
describe('Test de filtrado', () => {
  test('comprobar que searchPokemon es una funcion', () => {
    expect(typeof searchPokemon).toBe('function');
  }); 
  test('Test de comportamiento de filtrado', ()=>{
    expect(searchPokemon(data.pokemon, "venusaur")).toStrictEqual([{
      "num": "003",
      "name": "venusaur",
      "generation": {
          "num": "generation i",
...
describe('Test de orden por mayor', () => {
  test('comprobar que by Highest es una funcion', () => {
    expect(typeof byHighest).toBe('function');
  }); 
  test('ordena de mayor a menor', ()=>{
    expect(byHighest (data.pokemon)).toStrictEqual([{
        "num": "005",
        "name": "charmeleon",
        "generation": {
          "num": "generation i",
  ...
  describe('Test de orden por menor', () => {
    test('comprobar que byLowest es una funcion', () => {
      expect(typeof byLowest).toBe('function');
    }); 
    test('ordena de mayor a menor', ()=>{
        expect(byLowest (data.pokemon)).toStrictEqual([{
            "num": "001",
            "name": "bulbasaur",
            "generation": {
              "num": "generation i",
